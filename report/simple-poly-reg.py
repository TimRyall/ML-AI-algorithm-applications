...
for _ in range (1):
    ...
    for train_index, test_index in kf.split(X):
        ...
        X_train_poly = transformer.fit_transform(X_train) # adujst X to add polynomial terms
